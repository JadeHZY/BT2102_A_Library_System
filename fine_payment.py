...
def fine_page():
    ...
    member_label.place(x=100, y=90)
    member_id.place(x=100, y=110)
    date_label.place(x=100, y=135)
    date.place(x=100, y=155)
    fine_label.place(x=100, y=180)
    fine.place(x=100, y=200)
